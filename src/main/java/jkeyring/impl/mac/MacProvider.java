...
import jkeyring.KeyringConstants;
...
public class MacProvider implements IKeyring {
    ...
    private static final byte[] accountName = KeyringConstants.getAppName().getBytes(UTF8);
    ...
    public boolean enabled() {
        ...
        return osName.contains("darwin") || osName.contains("mac os x");
    }
